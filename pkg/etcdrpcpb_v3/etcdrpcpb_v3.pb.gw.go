...
/*
Package etcdrpcpb_v3 is a reverse proxy.
...
func local_request_Maintenance_Alarm_0(ctx context.Context, marshaler runtime.Marshaler, server MaintenanceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AlarmRequest
	var metadata runtime.ServerMetadata
...
func local_request_Maintenance_Hash_0(ctx context.Context, marshaler runtime.Marshaler, server MaintenanceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HashRequest
	var metadata runtime.ServerMetadata
...
func request_Maintenance_HashKV_0(ctx context.Context, marshaler runtime.Marshaler, client MaintenanceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HashKVRequest
	var metadata runtime.ServerMetadata
...
func local_request_Maintenance_HashKV_0(ctx context.Context, marshaler runtime.Marshaler, server MaintenanceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HashKVRequest
	var metadata runtime.ServerMetadata
...
func request_Maintenance_Downgrade_0(ctx context.Context, marshaler runtime.Marshaler, client MaintenanceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DowngradeRequest
	var metadata runtime.ServerMetadata
...
func local_request_Maintenance_Downgrade_0(ctx context.Context, marshaler runtime.Marshaler, server MaintenanceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DowngradeRequest
	var metadata runtime.ServerMetadata
